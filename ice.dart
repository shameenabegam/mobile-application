...
class iceState extends State<ice> {
  ...
  Widget build(BuildContext context) {
    ListTile makeListTile(Services services) => ListTile(
          ...
          trailing:
              Icon(Icons.keyboard_double_arrow_down, color: Colors.white, size: 30.0),
          onTap: () {
            Navigator.push(
                context,
                MaterialPageRoute(
...
List getServices() {
  return [
    Services(
      title: Strings.TITLE_DPSR_PRODUCT_NAME,
      indicatorValue: 0.50,
    ),
    Services(
      title: Strings.TITLE_DPSR_STUDENT,
      indicatorValue: 0.60,
    ),
    Services(
      title: Strings.TITLE_DPSR_SERVICES,
      indicatorValue: 0.70,
    ),
    Services(
      title: Strings.TITLE_DPSR_SPONSOR,
      indicatorValue: 0.80,
    ),
    Services(
      title: Strings.TITLE_DPSR_END,
      indicatorValue: 0.90,
    ),
  ];
}
